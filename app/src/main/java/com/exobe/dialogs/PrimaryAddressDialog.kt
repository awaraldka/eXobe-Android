...
class PrimaryAddressDialog(var updatePrimaryAddress: UpdatePrimaryAddress, var _id: String?) : DialogFragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var view= inflater.inflate(R.layout.primary_address_popup, container, false)
...
//        bodyTitle.text = title
        ...
        yes_btn.setSafeOnClickListener {
            updatePrimaryAddress.updateAddress(_id)
            dismiss()
        }
        return view
    }
